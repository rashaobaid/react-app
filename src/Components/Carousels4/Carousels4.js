  ...
  render() {
    return (
      ...
      <div className="container ">
        <SimpleSlider4 settings={this.settings} />
      </div>
      </div>
    );
  }
...
class SimpleSlider4 extends Component {
  constructor(props) {
        super(props);
        this.state = {
          error: null,
      ...
      componentDidMount() {
        fetch("https://raw.githubusercontent.com/rashaobaid/projectt1/master/self_improvement.json")
        .then(res => res.json())
        .then((data) => {
  ...
  render() {
    ...
    return (
      <div  className="slider  slide4" >
        <Row>
          <div><h2>Self Improvements sections</h2></div>
      </Row>
